...
def main():
    ...
    stuff2 = [[[] for _ in range(4)] for _ in range(2)]
            ...
            if file_name.endswith(".csv") or file_name.endswith(".txt"):
                ...
                if file_name.__contains__("random"):
                    ...
                    if file_name.__contains__("strict"):
                        ...
                        strictness = 2
                    elif file_name.__contains__("skeptical"):
                        strictness = 3
                    ...
                    if dirpath.__contains__("strict"):
                        ...
                        strictness = 1
                    elif dirpath.__contains__("lax"):
                        strictness = 2
                    elif dirpath.__contains__("skeptical"):
                        strictness = 3
